...
st.subheader("Analyze your data interactively using Python and Streamlit")
...
if upload is not None:
    ...
    if st.checkbox("Analyze Categorical Variables"):
        cat_column = st.selectbox("Select column for analysis", data.select_dtypes(include='object').columns)
...
if st.checkbox("About the Developer"):
